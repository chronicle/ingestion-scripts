...
from Citrix_Sessions.main import main, get_access_token
...
@mock.patch("Citrix_Sessions.main.get_env_var", side_effect = mock_get_env_var)
@mock.patch("Citrix_Sessions.main.ingest")
@mock.patch("Citrix_Sessions.main.create_new_session")
@mock.patch("Citrix_Sessions.main.requests.get")
class TestCitrixSessions(unittest.TestCase):
    ...
    def test_value_error(self, mocked_print, mocked_get, mocked_create_session, mocked_ingest, mocked_get_env_var):
        ...
        mocked_print.assert_called_with("ERROR: Unexpected data format received while collecting session metadata")
    ...
    @mock.patch("Citrix_Sessions.main.datetime")
    def test_log_retrieve_time(self, mocked_datetime, mocked_get, mocked_create_session, mocked_ingest, mocked_get_env_var):
    ...
    def test_no_logs_to_ingest(self, mocked_get, mocked_create_session, mocked_ingest, mocked_get_env_var):
    ...
    def test_pagination(self, mocked_get, mocked_create_session, mocked_ingest, mocked_get_env_var):
        ...
        expected_calls = [
            mock.call(
                ...
                [{"id": "1"}, {"id": "2"}], "CITRIX_SESSION_METADATA"
            ),
            mock.call(
                # Call ingest with 2nd page logs
                [{"id": "3"}, {"id": "4"}], "CITRIX_SESSION_METADATA"
            )
        ]
